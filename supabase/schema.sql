...
CREATE TABLE IF NOT EXISTS members (
    ...
    life_stage TEXT CHECK (life_stage IN ('兒童', '中學生', '大專生', '青職', '壯年', '年長')),
    source TEXT CHECK (source IN ('熟人介紹', '街頭接觸', '校園福音', '網絡接觸', '其他')),
    birthday DATE,
    notes_zh_hant TEXT,
    notes_zh_hans TEXT,
    avatar_url TEXT,
    ...
    status TEXT CHECK (status IN (
        'first_contact', 'warm_contact', 'son_of_peace', 'seeking',
        'newly_baptized', 'morning_revival', 'home_meeting', 'stable_group', 'stable_lord_day', 'ready_baptism'
    )),
